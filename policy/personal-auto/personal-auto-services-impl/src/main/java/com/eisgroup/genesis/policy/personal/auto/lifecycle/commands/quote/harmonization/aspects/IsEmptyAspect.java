...
/**
 * Specifies whether value should be set to empty
 *
 * @author sbelauski
 */
public class IsEmptyAspect implements AspectAdapter {
    ...
    public AspectColumnDescriptor describeAspect(AspectColumn column) {
        return new AspectColumnDescriptor(NAME, DataType.BOOLEAN);
    }
}

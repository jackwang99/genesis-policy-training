...
public class TFServiceExtraMethodHandlerImpl
    ...
    private static final String PERSONAL_AUTO_POLICY_CLASS = "org.openl.generated.beans.personalauto.Policy";
    ...
    public DefaultTfsCalculationResult invoke(final Method interfaceMethod, Object serviceBean, Object... args) throws Exception {
        DestinationClassResolver destinationClassResolver = s -> {
            try {
                return interfaceMethod.getDeclaringClass().getClassLoader().loadClass(PERSONAL_AUTO_POLICY_CLASS);
        ...
        Object policy = mapper.map(request.getNode(), PERSONAL_AUTO_POLICY_CLASS);
        ...
        return (DefaultTfsCalculationResult) serviceBean.getClass().getMethod("CalculateTaxesAndFees",
                ...
                interfaceMethod.getDeclaringClass().getClassLoader().loadClass(PERSONAL_AUTO_POLICY_CLASS))

...
/**
 * Handler for changing state of a Quote to `offerCompleted`
 *
 * @author yratkevich
 * @since 9.16
 */
public class CompleteOfferHandler extends QuoteCommandHandler<IdentifierRequest, PolicySummary> {

    @Override
    public String getName() {
        return PersonalAutoCommands.COMPLETE_OFFER;
    }

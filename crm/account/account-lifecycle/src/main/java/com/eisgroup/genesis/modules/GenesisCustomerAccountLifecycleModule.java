...
import com.eisgroup.genesis.account.conversion.ConversionWriteHandler;
...
public class GenesisCustomerAccountLifecycleModule extends CustomerAccountLifecycleModule {

    @Override
    public Map<String, CommandHandler<?, ?>> getCommandHandlers() {
        Map<String, CommandHandler<?, ?>> handlers = super.getCommandHandlers();
        handlers.put(CrmCommands.WRITE_CUSTOMER_ACCOUNT, new WriteHandlerRI());

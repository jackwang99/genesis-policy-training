...
import com.eisgroup.genesis.crm.validation.config.CrmValidationConfig;
...
@AutoConfigureBefore(CrmValidationConfig.class)
public class IndividualCustomerLifecycleModule extends CustomerLifecycleModule {
    ...
    public Map<String, CommandHandler<?, ?>> getCommandHandlers() {
        ...
        handlers.put(CrmCommands.SPLIT_CUSTOMER, new IndividualSplitHandler());
        return handlers;
    }
    ...
    public EntityNumberGenerator customerNumberGenerator(SequenceGenerator sequenceGenerator) {
        return new ModelAwareNumberGenerator(this.getModelName(),"customer_number", "IC","%010d", sequenceGenerator);
    }

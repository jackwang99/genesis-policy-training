...
import com.eisgroup.genesis.commands.campaign.conversion.ConversionWriteHandler;
...
public class ConversionWriteHandlerTest {
    ...
    @InjectMocks
    private ConversionWriteHandler writeHandler = new ConversionWriteHandler();
